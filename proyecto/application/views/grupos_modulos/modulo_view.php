                    ...
                    <tbody>
                         <?php for ($i = 0; $i < count($modelos); ++$i) { ?>
						     ...
						     <td><?php if(($modelos[$i]->s)==1){echo('si');}else{echo ('no');} ?></td>
                                   ...
                                   <td><a href="<?php echo base_url('index.php/grupos_modulos/eliminar/'.$modelos[$i]->id_del_grupo.'/'.$modelos[$i]->id_del_modulo);?>" class="btn btn-info"  >actualizar</a><a href="<?php echo base_url('index.php/grupos_modulos/eliminar/'.$modelos[$i]->id_del_grupo.'/'.$modelos[$i]->id_del_modulo);?>" class="btn btn-danger"  >eliminar</a></td>
